...
class Popupcreator{
    ...
    public function __construct(){
        add_action( 'plugins_loaded',array($this,'load_textdomain' ));
     	add_action( 'init',array($this,'register_cpt_group') );
...
wp_enqueue_script( 'popupcreator-main', plugin_dir_url( __FILE__ ) . "assets/js/popupcreator.js", array
	       (
			'jquery',
			'plainmodal-js'
		   ), time(), true );
		...
		?>
            <div class="modal-content" data-modal-id="<?php the_ID();?>" data-size="<?php echo $size; ?>">
                <div><img class="close-button" width="30"
                          src="<?php echo plugin_dir_url( __FILE__ ) . "assets/img/y.png"; ?>" alt="<?php _e( 'Close', 'popupcreator' ) ?>">
                </div>
                <img src="https://images.unsplash.com/photo-1542352441-be5a02528a68?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60"
                     alt="Popup">
